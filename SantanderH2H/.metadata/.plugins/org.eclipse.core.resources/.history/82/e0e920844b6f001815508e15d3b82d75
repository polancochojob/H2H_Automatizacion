...
public class CreateAndTransferFiles {
	...
	private static void Iniciar (String FilePaths) throws Exception
	{
		...
		System.out.println("******** Inicio de  Ejecución de Creación de Archivos ********" + "\r\n");
		crearLog("******** Inicio de  Ejecución de Creación de Archivos ********" + "\r\n");
		TestConsultar.escribeword("Inicio de  Ejecución de Creación de Archivos",true,8,false,"Lucida Sans Unicode","izquierda");
		System.out.println("(" + hora("") + ") 1. Indicar Rutas y Archivo de Configuración");
		crearLog("(" + hora("") + ") 1. Indicar Rutas y Archivo de Configuración");
		System.out.println("(" + hora("") + ") 2. Abrir archivo de configuración");
		crearLog("(" + hora("") + ") 2. Abrir archivo de configuración");
		TestConsultar.escribeword(" ",false,10,false,"Lucida Sans Unicode","izquierda");

		ViewFileConfig();

		System.out.println("(" + hora("") + ") 4. Fin de Generación de archivos");
		crearLog("(" + hora("") + ") 4. Fin de Generación de archivos" + "\r\n");
		crearLog("La ejecución fue realizada por el usuario: " + UserName + "\r\n");
		crearLog("*****************************************************************************************" + "\r\n");
	...
	{
		System.out.println("(" + hora("") + ") 3. Lectura del archivo de configuración" + "\r\n");
		crearLog("(" + hora("") + ") 3. Lectura del archivo de configuración" + "\r\n");

		System.out.println("******** Creación de archivos y transferencia al Servidor SFTP ********" + "\r\n");
		crearLog("******** Creación de archivos y transferencia al Servidor SFTP ********" + "\r\n");
		TestConsultar.escribeword("Creación de archivos y transferencia al Servidor SFTP",false,8,false,"Lucida Sans Unicode","izquierda");
		...
		String fichero = FilePath + FileConfig;
		    ...
		    try {
		      ...
		      while((linea = br.readLine()) != null)
		      {
		    	  ...
		    	  if (i>1 )
		    	  {
		    		  System.out.println("(" + hora("") + ") * Envió de Línea del archivo para separación de campos");
		    		  crearLog("(" + hora("") + ") * Envió de Línea del archivo para separación de campos");
		    		  TestConsultar.escribeword(" ",false,10,false,"Lucida Sans Unicode","izquierda");
		    		  ViewData(linea);
		    	  }
		      }
	...
	private static void ViewData (String Linea) throws Exception
	{
		...
		System.out.println("(" + hora("") + ") * Separación de los valores por campo");
		crearLog("(" + hora("") + ") * Separación de los valores por campo");
		...
		System.out.println("(" + hora("") + ") * Creación del archivo con base a los datos obtenidos");
		crearLog("(" + hora("") + ") * Creación del archivo con base a los datos obtenidos");
		TestConsultar.escribeword("* Creación del archivo con base a los datos obtenidos\n\r",false,8,false,"Lucida Sans Unicode","izquierda");
		
		TestConsultar.escribeword("* Creación del archivo: " + FileName ,false,8,false,"Lucida Sans Unicode","izquierda");
		...
		TestConsultar.escribeword("* Validación de la copia del archivo: " + FileName + " a la carpeta 'respaldo'",false,8,false,"Lucida Sans Unicode","izquierda");
	...
	private static String SFTPDataConnection() throws IOException
	{
		...
		System.out.println("(" + hora("") + ") * Obteniendo datos de conexión a repositorio SFTP" + "\r\n");
		crearLog("(" + hora("") + ") * Obteniendo datos de conexión a repositorio SFTP" + "\r\n");
	...
	private static void DownloadFiles(String pUser, String pPass,String pHost, int pPort, String FileName, String pOutputStream, String pPathFile) throws Exception
	{
        ...
        try {
        	...
        	System.out.println("(" + hora("") + ") * Descarga del archivo de finalización de transferencia");
        	crearLog("(" + hora("") + ") * Descarga del archivo de finalización de transferencia");
		  ...
		  try
		  {
            ...
            do
            {
            	...
            	for (i = 0; i < filelist.size(); i++)
            	{
            		...
            		{
            			System.out.println("(" + hora("") + ") * Se realizó el respaldo del archivo " + FileName);
            			crearLog("(" + hora("") + ") * Se realizó el respaldo del archivo " + FileName);
            			TestConsultar.escribeword("* Se realizó el respaldo del archivo " + FileName,false,8,false,"Lucida Sans Unicode","izquierda");
            			p=1;
            			break;
            		}
            	}
            	...
            	if (cont >= 24)
            	{
            		System.out.println("(" + hora("") + ") * No se realizó el respaldo del archivo " + FileName);
            		crearLog("(" + hora("") + ") * No se realizó el respaldo del archivo " + FileName);
            		TestConsultar.escribeword("* No se realizó el respaldo del archivo " + FileName,false,8,false,"Lucida Sans Unicode","izquierda");
            		p=1;
            		break;
            	}
